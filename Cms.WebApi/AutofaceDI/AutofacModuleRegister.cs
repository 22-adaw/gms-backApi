...
namespace Gms.WebApi.AutofaceDI
{
    public class AutofacModuleRegister: Autofac.Module
    {
        ...
        {
            base.Load(builder);
            var AppServices = Assembly.Load("Gms.Service");
            var IAppServices = Assembly.Load("Gms.IService");
            var AppRepository = Assembly.Load("Gms.Repository");
            var IAppRepository = Assembly.Load("Gms.IRepository");
